...
test('first day of week is Monday, month starts on Monday', (t) => {
  ...
  const month = formatMonth(mnth(date))
...
test('first day of week is Monday, month starts on Sunday', (t) => {
  const date = parseDate('2018-04-01')
  const month = formatMonth(mnth(date))
...
test('first day of week is Monday, month ends on Sunday', (t) => {
  const date = parseDate('2017-04-01')
  const month = formatMonth(mnth(date))
...
test('first day of week is Monday, February, leap year', (t) => {
  const date = parseDate('2016-02-01')
  const month = formatMonth(mnth(date))
...
test('first day of week is Tuesday, month starts on Tuesday', (t) => {
  const date = parseDate('2018-05-01')
  const month = formatMonth(
    mnth(date, { firstDay: 2 })
  )
...
test('first day of week is Tuesday, month starts on Monday, 6 weeks', (t) => {
  const date = parseDate('2018-10-01')
  const month = formatMonth(
    mnth(date, { firstDay: 2 })
  )
...
test('first day of week is Tuesday, month ends on Monday', (t) => {
  const date = parseDate('2018-12-01')
  const month = formatMonth(
    mnth(date, { firstDay: 2 })
  )
...
test('first day of week is Wednesday, month starts on Wednesday', (t) => {
  const date = parseDate('2018-08-01')
  const month = formatMonth(
    mnth(date, { firstDay: 3 })
  )
...
test('first day of week is Wednesday, month ends on Tuesday', (t) => {
  const date = parseDate('2018-07-01')
  const month = formatMonth(
    mnth(date, { firstDay: 3 })
  )
...
test('first day of week is Thursday, month starts on Thursday, 4 weeks', (t) => {
  const date = parseDate('2018-02-01')
  const month = formatMonth(
    mnth(date, { firstDay: 4 })
  )
...
test('first day of week is Friday, month starts on Friday', (t) => {
  const date = parseDate('2018-06-01')
  const month = formatMonth(
    mnth(date, { firstDay: 5 })
  )
...
test('first day of week is Friday, month starts on Thursday, 6 weeks', (t) => {
  const date = parseDate('2018-03-01')
  const month = formatMonth(
    mnth(date, { firstDay: 5 })
  )
...
test('first day of week is Saturday, month starts on Saturday', (t) => {
  const date = parseDate('2018-09-01')
  const month = formatMonth(
    mnth(date, { firstDay: 6 })
  )
